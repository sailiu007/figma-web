...
import type { Project, Role, Permission, ActivityItem, Credential, DataDict, User } from '../types';
...
export const users: User[] = [
  {
    ...
    name: '林澈',
    nameEn: 'Ethan Lin',
    email: 'ethan.lin@atlas.local',
    title: '平台负责人',
    titleEn: 'Platform Lead',
    team: '平台架构组',
    teamEn: 'Platform Architecture',
    status: 'active',
  ...
  },
  {
    ...
    name: '陈拓',
    nameEn: 'Tony Chen',
    email: 'tony.chen@atlas.local',
    title: '前端负责人',
    titleEn: 'Frontend Lead',
    team: '应用研发',
    teamEn: 'Application Engineering',
    status: 'active',
    preferredLanguage: 'zh',
    roleIds: ['r3'],
    color: '#0f766e',
  },
  {
    ...
    name: '邱然',
    nameEn: 'Renee Qiu',
    email: 'renee.qiu@atlas.local',
    title: '测试架构师',
    titleEn: 'QA Architect',
    team: '质量保障',
  ...
  },
  {
    ...
    name: '唐远',
    nameEn: 'Aaron Tang',
    email: 'aaron.tang@atlas.local',
    title: 'DevOps 工程师',
    titleEn: 'DevOps Engineer',
    team: '基础设施',
    teamEn: 'Infrastructure',
    status: 'active',
    preferredLanguage: 'en',
    roleIds: ['r5'],
    color: '#7c3aed',
  },
  {
    ...
    name: '韩璐',
    nameEn: 'Lucy Han',
    email: 'lucy.han@atlas.local',
    title: '产品分析师',
    titleEn: 'Product Analyst',
    team: '产品策略',
    teamEn: 'Product Strategy',
    status: 'invited',
    preferredLanguage: 'zh',
    roleIds: ['r6'],
    color: '#64748b',
  ...
  },
  {
    ...
    name: '宋微',
    nameEn: 'Vera Song',
    email: 'vera.song@atlas.local',
    title: '解决方案顾问',
    titleEn: 'Solutions Consultant',
    team: '客户成功',
